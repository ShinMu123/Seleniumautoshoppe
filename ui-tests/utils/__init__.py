"""Shared Selenium utility helpers for legacy web smoke tests.

Contains driver setup, resilient element actions, and common navigation
helpers used by the older web-based test scripts.
"""
